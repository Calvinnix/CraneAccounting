...
public class DatabaseLoader implements CommandLineRunner {
    ...
    public void run(String... strings) throws Exception {
        ...
        this.chartOfAccountsDao.save(new ChartOfAccounts(401.0, "Delivery Fees", "Revenues", false, 77L, "Operating Revenues"));
        this.chartOfAccountsDao.save(new ChartOfAccounts(401.0, "Appraisal Fees", "Revenues", false, 78L, "Operating Revenues"));
        this.chartOfAccountsDao.save(new ChartOfAccounts(401.0, "Service Fees", "Revenues", false, 79L, "Operating Revenues"));
        this.chartOfAccountsDao.save(new ChartOfAccounts(401.0, "Repair Fees", "Revenues", false, 80L, "Operating Revenues"));
        this.chartOfAccountsDao.save(new ChartOfAccounts(401.0, "Sales", "Revenues", false, 81L, "Operating Revenues"));
        this.chartOfAccountsDao.save(new ChartOfAccounts(401.1, "Sales Returns and Allowances", "Revenues", false, 82L, "Operating Revenues"));
        this.chartOfAccountsDao.save(new ChartOfAccounts(401.2, "Sales Discounts", "Revenues", false, 83L, "Operating Revenues"));
